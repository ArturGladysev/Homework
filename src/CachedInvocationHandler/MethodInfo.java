...
/*Класс генерирует уникальный ключ из имени класса, аргументов и булевых флагов.
  Это позволяет находить результаты работы метода с разными аргументами или без них.
  Уникальность проверяется через equals, ключ генерируется через toString.
*/
